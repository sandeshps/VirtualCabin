<%@ Page Title="" Language="C#" MasterPageFile="~/admin/Home.master" AutoEventWireup="true" CodeFile="Compose.aspx.cs" Inherits="admin_Compose" %>
        ...
        <tr>
            <td>
                <asp:Image ID="Image2" runat="server" Height="249px" 
                    ImageUrl="~/images/compose.jpg" Width="299px" />
            </td>
            <td>
                <table class="style3">
                    <tr>
