...
public partial class employee_Inbox : System.Web.UI.Page
{
    string query;
    ...
    {
        //checkedToTrue();
        /* Go through each row and find which row has been checked. 
        ...
        if (count == 0) // If no checkbox has been selected
        {
            lblMessage.Text = "Please select";
        }
        else if (count == grdInbox.Rows.Count)
        {
