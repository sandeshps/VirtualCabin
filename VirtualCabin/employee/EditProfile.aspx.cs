...
public partial class employee_EditProfile : System.Web.UI.Page
{
    database db = new database();
    SqlDataReader reader;
    static int globalStatus = 1;
    ...
    protected void btnUpdate_Click(object sender, EventArgs e)
    {
        try
        {
            /* If any one of the drop-down-list is null, then have seperate queries, because while updating, null values can't be
             * inserted. */
            //if (drpCountry.SelectedValue == null || drpState.SelectedValue == "" || drpCity.SelectedValue == "")
            //{
            //    if (drpCountry.SelectedValue == null)
            //    {
            //        update_query = "update Registration set FirstName='" + txtFirstName.Text + "',LastName='" + txtLastName.Text + "',EmailId='" + txtMailId.Text + "',Address='" + txtAddress.Text + "',State='" + drpState.SelectedItem.ToString() + "',City='" + drpCity.SelectedItem.ToString() + "',Mobile='" + txtPhone.Text + "' where username='" + lblUsername.Text + "'";
            ...
            //    {
            //        update_query = "update Registration set FirstName='" + txtFirstName.Text + "',LastName='" + txtLastName.Text + "',EmailId='" + txtMailId.Text + "',Address='" + txtAddress.Text + "',Country='" + drpCountry.SelectedItem.ToString() + "',City='" + drpCity.SelectedItem.ToString() + "',Mobile='" + txtPhone.Text + "' where username='" + lblUsername.Text + "'";
            //        db.database_command(update_query);
            //        fileUpload();
            //        lblMessage.Text = "Changes saved";
            //    }
            ...
            //    {
            //        update_query = "update Registration set FirstName='" + txtFirstName.Text + "',LastName='" + txtLastName.Text + "',EmailId='" + txtMailId.Text + "',Address='" + txtAddress.Text + "',Country='" + drpCountry.SelectedItem.ToString() + "',State='" + drpState.SelectedItem.ToString() + "',Mobile='" + txtPhone.Text + "' where username='" + lblUsername.Text + "'";
            //        db.database_command(update_query);
            //        fileUpload();
            //        lblMessage.Text = "Changes saved";
            //    }
