...
public partial class employer_Reply : System.Web.UI.Page
{
    ...
    // This module will reply back to the sender
    protected void btnSend_Click(object sender, EventArgs e)
    {
        try
        {
            if (txtFrom.Text.Trim() == "" || txtTo.Text.Trim() == "" || txtSubject.Text.Trim() == "")
            {
