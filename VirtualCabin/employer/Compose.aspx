<%@ Page Title="" Language="C#" MasterPageFile="~/employer/Employer.master" AutoEventWireup="true" CodeFile="Compose.aspx.cs" Inherits="employer_Compose" %>
        ...
        <tr>
            <td>
                <asp:Image ID="Image2" runat="server" Height="499px" 
                    ImageUrl="~/images/compose.jpg" Width="337px" />
            </td>
            <td>
                <table class="style3">
                    <tr>
